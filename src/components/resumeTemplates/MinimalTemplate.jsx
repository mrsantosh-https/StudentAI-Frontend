export default function MinimalTemplate({ resume = {} }) {
  ...
  return (
    <div className="minimal-resume-template" id="resume-template">
      <header className="minimal-resume-header">
        <h1>{name}</h1>
        <p className="minimal-resume-role">{role}</p>
      ...
      <main className="minimal-resume-content">
        <section className="minimal-resume-section">
          <h2>Profile</h2>
          <p>{summary}</p>
        </section>
        ...
        <section className="minimal-resume-section">
          ...
          {experience.length > 0 ? (
            ...
            <p className="resume-empty-text">No experience added</p>
          )}
        </section>
