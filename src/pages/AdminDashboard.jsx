  ...
  useEffect(() => {
    ...
    const fetchAdminStats = async () => {
      try {
        ...
        setStats({
          total_users:
            Number(adminStats.total_users) || 0,

          total_resumes:
            Number(adminStats.total_resumes) || 0,

          admin_users:
            Number(adminStats.admin_users) || 0,

          normal_users:
            Number(adminStats.normal_users) || 0,
        });
      } catch (error) {
        console.error(
